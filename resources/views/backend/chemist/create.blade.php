            ...
            <div class="col-lg-12 col-md-12">
                ...
                <div class="body">
					...
					<div class="input-group mb-3">
                        ...
                        <input type="email" class="form-control"  aria-describedby="basic-addon3" name="email_id" value="@if(empty($chemist)){{old('email_id')}}@else{{$chemist->email_id}}@endif"placeholder="Enter Email Id">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                   ...
                   <div class="input-group mb-3">
					...
					<div class="input-group mb-3">
						...
						placeholder="{{ __('general.enter_description') }}">@if(empty($chemist)){{old('description')}}@else{{$chemist->description}}@endif</textarea>
				   </div>
                        ...
                        @if(count($shopimages))
                            @foreach($shopimages as $value)
                                <div class="input-group mb-2" style="align:left;">
                                    <img height="100" width="100" src="{{ url("/upload/chemist/")}}/{{$value->image_name}}" />
