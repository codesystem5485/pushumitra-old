    ...
    <div class="container-fluid">
        <div class="block-header">
            <div class="row">
                <div class="col-lg-5 col-md-8 col-sm-12">
                    ...
                    {{ __('general.edit_otheruser')}}
                    @else
                    {{ __('general.create_otheruser')}}
                    @endif  </h2>
                <ul class="breadcrumb"> 
                    <li class="breadcrumb-item"><a href="{{url('/')}}"><i class="icon-home"></i></a></li>
                    <li class="breadcrumb-item"><a href="{{$url['listUrl']}}">{{ __('general.otheruser_list')}}</a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12">
                ...
                <form action="@if(empty($user)){{route('otheruser.store')}}@else{{route('otheruser.update',['id' => $user->id])}}@endif" method="post" enctype="multipart/form-data"> 
                    @csrf  
                <div class="body">
