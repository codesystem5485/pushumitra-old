    ...
    <div class="container-fluid">
        <div class="block-header">
            <div class="row">
                ...
                <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Categories List</h2>
                <ul class="breadcrumb">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                ...
                @include('backend.layouts.flash-message')
                    ...
                    <a href="{{$url['createUrl']}}" class="btn btn-info">Add Type(Subcategories) </a>
                    @endcan
                </div>
                <div class="body">
                        ...
                        <table class="table table-bordered table-hover js-basic-example dataTable table-custom">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('categories.delete',['id' => $type->id])}}" onclick="return confirm('Do you really want to delete the record(s)?')">
