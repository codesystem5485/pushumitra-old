    ...
    <div class="container-fluid">
        <div class="block-header">
            <div class="row">
                ...
                <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>{{ __('general.poultryhatchery_list') }}</h2>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{url('/dashboard')}}"><i class="icon-home"></i></a></li>
                    <li class="breadcrumb-item">{{ __('general.poultryhatchery_list') }}</li>
                </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="body">
                    ...
                    <table class="table table-bordered table-hover table-custom" id="user_datatable">
                            <thead>
                            <tr>
								<th>{{ __('general.poultryhatchery_name') }}</th>
								<th>{{ __('general.poultryhatchery_incharge') }}</th>                                 
...
<script>
    $(document).ready( function () {
       var table =  $('#user_datatable').DataTable({
           ...
           serverSide: true,
            ajax: {
                "url":"{{ route('poultryhatchery.list') }}",
                "type": "GET",
                "data": function(d){
                    //d.role = $("#role").val();
                }
            ...
            columns: [
                ...
                { data: 'poultryhatchery_center_name', name: 'poultryhatchery_center_name' },
