    ...
    <div class="container-fluid">
        <div class="block-header">
            <div class="row">
                ...
                <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>{{ __('general.easycare_list') }}</h2>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{url('/dashboard')}}"><i class="icon-home"></i></a></li>
                    <li class="breadcrumb-item">{{ __('general.easycare_list') }}</li>
                </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="body">
                    ...
                    <table class="table table-bordered table-hover table-custom" id="user_datatable">
                            <thead>
                            <tr>
								<th>{{ __('general.easycare_title') }}</th>                                
