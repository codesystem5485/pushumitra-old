            ...
            <div class="col-lg-12 col-md-12">
				...
				<div class="input-group mb-3">
					...
					<div class="input-group mb-3">
                        ...
                        <input type="email" class="form-control"  aria-describedby="basic-addon3" name="email_id" value="@if(empty($shops)){{old('email_id')}}@else{{$shops->email_id}}@endif"placeholder="Enter Email Id">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
...
<script>
    ...
    $(document).on('click',".removeImage",function(e){
        ...
        var actionurl = webUrl+"/shops/"+image_val+"/remove";
         $.ajax({
            url: actionurl,
            type: "get",
