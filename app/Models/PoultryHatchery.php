...
class PoultryHatchery extends Model
{
    ...
    protected $fillable = ['id','registration_number','email_id','user_id','breed','price_chick','user_code','latitude','longitude','subscriptionStartDate','subscriptionEndDate','taluka','district',
