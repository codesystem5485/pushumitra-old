...
class RegVetSubscriptionReminder extends Command
{
   ...
   /**
     ...
     * @var string
     */
    protected $signature = 'reminder:regvetsubscription';
     ...
     * @var string
     */
    protected $description = 'regvetsubscription end reminder';
    ...
    public function handle()
    {
		...
		->select('fcm_id','full_name','subscriptionEndDate','rv_code')
